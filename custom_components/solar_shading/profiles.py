...
def built_in_house_defaults() -> dict[str, Any]:
    ...
    return {
        ...
        CONF_NIGHT_MORNING_LATEST_TIME: None,
        CONF_COVER_LOCATION: COVER_LOCATION_EXTERIOR,
...
def resolve_profile_options(
    ...
    *,
    ...
    if facade_name and facade_profile:
        ...
        resolved[CONF_AZIMUTH] = int(
            round((reference + facade_offset + window_offset) % 360)
        )
