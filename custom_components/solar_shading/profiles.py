...
def built_in_house_defaults() -> dict[str, Any]:
    ...
    return {
        ...
        CONF_HOT_DAY_CLOSE_ENABLED: True,
        CONF_HOT_DAY_CLOSE_THRESHOLD: 28,
        CONF_HOT_DAY_CLOSE_POSITION: 30,
        CONF_VERY_HOT_DAY_CLOSE_POSITION: 15,
...
def resolve_profile_options(
    ...
    *,
    ...
    _merge(resolved, dict(house.get(CONF_HOUSE_DEFAULTS) or {}), "house", sources)
    layers.append("house")
